...
class Palette {
  ...
  Color textColor(context) => Theme.of(context).brightness == Brightness.dark ? grey : black;
  Color hintColor(context) => Theme.of(context).brightness == Brightness.dark ? light : dark;
