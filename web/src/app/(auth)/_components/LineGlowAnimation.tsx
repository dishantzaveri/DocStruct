...
export const SVGLineGlowAnimateContainer = () => {
  return (
    <div className="flex">
      <SVGLineGlowAnimate movementDelay={0} id={1} initialGradientY={0} />
      <SVGLineGlowAnimate
        movementDelay={2000}
        id={2}
        initialGradientY={20}
        additionalHeight={20}
      />
      <SVGLineGlowAnimate movementDelay={4000} id={3} additionalHeight={40} />
      <SVGLineGlowAnimate
        movementDelay={2000}
        id={4}
        initialGradientY={20}
        additionalHeight={20}
      />
      <SVGLineGlowAnimate movementDelay={0} id={5} initialGradientY={0} />
    </div>
  );
};
